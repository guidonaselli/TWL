...
public class UiGameplay : UiManager
{
    ...
    public void Draw(SpriteBatch sb)
    {
        ...
        // Nivel
        var levelText = Loc.TF("UI_LevelFormat", _player.Level);
        if (_player.RebirthLevel > 0)
        {
            levelText += $" (R{_player.RebirthLevel})";
        }
        sb.DrawString(_font,
            levelText,
        ...
        sb.FillRectangle(
            ...
            Color.Red);
        sb.DrawRectangle(
            new Rectangle(statsX, 60, 200, 10), Color.DarkRed);
        ...
        sb.DrawRectangle(
            new Rectangle(statsX, 95, 200, 10), Color.DarkBlue);
        ...
        sb.FillRectangle(
            ...
            Color.LightGreen);
        sb.DrawRectangle(
            new Rectangle(statsX, 130, 200, 6), Color.DarkGreen);
